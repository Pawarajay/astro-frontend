...
//             className="flex justify-center items-center w-full"
//           >
//             {/* 180px wide on mobile — fits nicely without dominating */}
//             <AstrologerVideoCard width="180px" ringSize="160px" />
//           </motion.div>
...
//           >
//             {/* clamp: min 160px → max 220px — proportional to viewport, never oversized */}
//             <AstrologerVideoCard width="clamp(160px, 16vw, 220px)" ringSize="clamp(150px, 15vw, 200px)" />
//           </motion.div>
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center gap-6 lg:hidden">
          ...
          {/* MOBILE — Video: fixed 260px width, centered */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.85, delay: 0.3, ease }}
        ...
        >
          ...
          {/* COL 3 — Astrologer Video
              ─────────────────────────────────────────────────────────
              Desktop: scales from 215px (1024px viewport / lg breakpoint)
              up to 380px (≥1920px viewport) using clamp.
              ringSize tracks the video width with ~10px breathing room.
              ───────────────────────────────────────────────────────── */}
          <motion.div
            initial={{ opacity: 0, x: 40 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <AstrologerVideoCard
              ...
              ringSize="clamp(190px, 19vw, 340px)"
            />
          </motion.div>
